...
base_flange = cq.Workplane("XY").circle(283 / 2).extrude(10)

# Step 2: Create the raised face
raised_face = cq.Workplane("XY").circle(89 / 2).extrude(155)

# Combine the base flange and raised face
combined = base_flange.union(raised_face)

# Step 3: Create the bore
result = combined.faces(">Z").workplane().hole(48)
